          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-sm font-medium">نظام الصيد</Label>
              </div>
              <StatusIndicator 
            ...
            <div className="mt-3">
              <RadioGroup value={fishingSystem} onValueChange={setFishingSystem} className="flex flex-col space-y-2" disabled={isFishCommandActive || isFishBonusActive}>
